...
2. copy (ligne 193) permettant de faire une copie du tableau bidimensionnel (de l'image).
...
Exlication de l'algorithme pour la méthode ConnectedPixels (ligne 237):
