...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //testConnectedPixels1_1();
    //testConnectedPixels1_2();
    //testConnectedPixels1_3();
    ...
    //testCompareFingerprints("1_1", "1_6", true);  //expected match: false
    //testCompareFingerprints("1_1", "5_5", false);  //expected match: false
    //testCompareFingerprints("1_1", "7_5", false);  //expected match: false


    //compare 1_1.png with 2_1.png: they are not supposed to match
    //testCompareFingerprints("1_5", "2_1", false); //expected match: false
    ...
    //compare 1_1 with all images of finger 2 to 16
    //for (int f = 2; f <= 16; f++) {
    //  testCompareAllFingerprints("1_1", f, false);
    //}

    //compare 1_2 with all images of finger 2 to 16
    //for (int f = 2; f <= 16; f++) {
   ...
   *
   * Added: Image rotated each pi/2 rad.
   */
  ...
  public static void testConnectedPixels1_1() {
    System.out.print("testConnectedPixels1_1: ");
    ...
    boolean[][] expected = {{false, false, false, false},
                            ...
                            {false, true, true, false},
                            {false, false, true, true}};
    boolean[][] connectedPixels = Fingerprint.connectedPixels(image, 1, 1, 10);
    if (arrayEqual(connectedPixels, expected)) {
      System.out.println("OK");
    } else {
      System.out.println("ERROR");
  ...
  public static void testConnectedPixels1_2() {
    System.out.print("testConnectedPixels1_2: ");
    ...
    boolean[][] connectedPixels = Fingerprint.connectedPixels(image, 1, 2, 10);
    if (arrayEqual(connectedPixels, expected)) {
      System.out.println("OK");
    } else {
      System.out.println("ERROR");
  ...
  public static void testConnectedPixels1_3() {
    System.out.print("testConnectedPixels1_3: ");
    boolean[][] image = {{true, true, false, false},
                        {false, true, true, false},
  ...
  public static void testOrientation_1() {
    boolean[][] image1 = {{false, false, false, true},
                          {false, true, false, false},
                          {false, true, true, false},
                          {false, false, true, true}};

    int angle = Fingerprint.computeOrientation(image1, 1, 1, 3);
    System.out.println("Expected angle: 305\t Computed angle: " + angle);
  }

  public static void testOrientation_2() {
    boolean[][] image2 = {{false, false, false, false},
                          {false, true, true, false},
                          {true, true, false, false},
                          {true, false, false, true}};

    int angle = Fingerprint.computeOrientation(image2, 1, 2, 3);
    System.out.println("Expected angle: 215\t Computed angle: " + angle);
  }

  public static void testOrientation_3() {
    boolean[][] image3 = {{true, true, false, false},
                          {false, true, true, false},
                          {false, false, true, false},
                          {true, false, false, false}};
    int angle = Fingerprint.computeOrientation(image3, 2, 2, 3);
    System.out.println("Expected angle: 125\t Computed angle: " + angle);
  }
